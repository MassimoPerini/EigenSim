...
class SLIM_Structure_Cython(Similarity_Matrix_Recommender, Recommender):
    ...
    def fit(self, epochs=300, logFile=None, URM_test=None, filterTopPop = False, minRatingsPerUser=1,
        ...
        if structure_mode == "similarity":
            similarity = Cosine_Similarity(self.ICM.T, shrink=0, topK=topK, normalize=False, mode = "cosine")
    ...
    def runCompilationScript(self):
        ...
        compiledModuleSubfolder = "/SLIM_ElasticNet/Cython"
        fileToCompile_list = ['SLIM_Structure_Cython_Epoch.pyx']
        ...
        # cython -a SLIM_Structure_Cython_Epoch.pyx
