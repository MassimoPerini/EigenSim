...
from Recommenders.Lambda.Cython.Lambda_BPR_Cython import SLIM_BPR_Cython as Lambda_HO
...
file_path = os.path.expanduser('dataset/bx_subsampled.txt')
dataframe = load_dataframe(file_path, ',')
#dataset = Dataset(dataframe, user_key='userId', item_key='movieId', rating_key='rating')
dataset = Dataset(dataframe, user_key='User-ID', item_key='ISBN', rating_key='Book-Rating') #"User-ID";"ISBN";"Book-Rating"
