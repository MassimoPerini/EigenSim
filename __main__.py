...
lam = Lambda_HO(URM_train, recompile_cython=False, sgd_mode="adagrad", pseudoInv=True, check_stability=False, save_lambda=True, save_eval=True)
...
lam.fit(epochs=12,URM_test=URM_test, learning_rate=0.0005, alpha=0, batch_size=1, rcond = 0.13, validate_every_N_epochs=1, start_validation_after_N_epochs=0, initialize = "zero")
